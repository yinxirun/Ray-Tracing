...
uint32 MemCrc32(const void *InData, int32 Length, uint32 CRC)
{
...
/////////////////////////////////////////////////////////////////
uint32 CRCTablesSB8_DEPRECATED[8][256] =
    {
...
namespace Internal
{
    static __forceinline uint32 ByteSwapGeneric32(uint32 Value)
    {
        return (BYTESWAP_ORDER32_unsigned(Value));
    }
}

__forceinline uint32 BYTESWAP_ORDER32(uint32 Val)
{
